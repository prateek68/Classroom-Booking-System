...
/**
 * Class that enables a students to add or remove courses
...
public class course_controller {
	...
	/**
	 * @throws IOException
	 * Function that enables a user to add any course from a list of course
	 */
	@FXML
...
//			System.out.println(toremove.get(i));
	...
	/**
	 * @param s
	 * String that has the name of a course
	 * @return
	 * Function returns whether the Course s can be added by that student or not
	 */
...
//		allcourselist.add(mycourses.getValue());
	...
	/**
	 * @param course_name
	 * String that stores the name of a course
	 * @return
	 * returns whether the student already has that course or not
	 */
	...
	/**
	 * @param s
	 * String stores the name of a course
	 * @return
	 * returns true if this course cannot be added by student because of clash is timetable for this 
	 * course and his/her existing courses
	 */
