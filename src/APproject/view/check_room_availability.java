...
/**
 * Class that enables a student to check the rooms available and the make request for any 
 * available room
...
public class check_room_availability {
	...
	/**
	 * @throws IOException
	 * Function that display all the available room for a particular time slot
	 */
	@FXML
...
//		input.close();
	...
	/**
	 * @throws IOException
	 * Function that creates a page that enables a student to make a request
	 */
	@FXML
