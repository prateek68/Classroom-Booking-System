...
/**
 * Class that creates a GUI page that enables an Admin or a Faculty of check room availability at a 
 * particular time slot and book a room accordingly
...
public class room_status_controller {
	...
	/**
	 * @throws IOException
	 * a function to display the list of available rooms
	 */
	@FXML
...
//		input.close();
	...
	/**
	 * @throws IOException
	 *  a function that cancels a previously booked rooms
	 */
	@FXML
