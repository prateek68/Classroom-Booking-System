...
/**
 * Courses class is used to create a new course.
 * This class also has the information about class timings of that particular course and respective venue 
 * of the class. 
...
public class Courses implements Serializable{
	...
	/**
	 * @param m
	 * A string that contains information that whether course is a mandatory course or an elective
	 * @param name
	 * A string that has course name
	 * @param code
	 * A string that has course code
	 * @param i
	 * A string that knows about the instructor
	 * @param acry
	 * A string that stores course acronym
	 * @param credits
	 * A string that has course credits
	 * @param pre
	 * An ArrayList of type string that has course pre conditions
	 * @param post
	 * An ArrayList of type string that has course post conditions
	 */
