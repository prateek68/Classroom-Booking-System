package APproject;
/**
 * An adapter class to convert Courses type Objects and to a type that can be displayed in combobox
...
public class courses_view {	
	...
	public courses_view(String s1, String s2, String s3, String s4, String s5, String s6, String s7, String s8,
	...
	public courses_view(String s1,String s2)
	{
		this.s1=s1;
		this.s2=s2;
	}
